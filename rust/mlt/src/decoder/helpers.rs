...
use crate::metadata::proto_tileset::{column, scalar_column, Column, ScalarType};
...
#[test]
fn test_get_scalar_type_from_column() {
    ...
    let ty = get_scalar_type_from_column(&column_metadata).expect("should parse ScalarType");
    assert_eq!(ty, ScalarType::Uint32);
}
